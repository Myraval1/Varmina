                                                                ...
                                                                <div className="flex items-center gap-3">
                                                                    {product.images?.[0] ? (
                                                                        <div className="relative flex-shrink-0">
                                                                            <img src={product.images[0]} className="w-24 h-28 rounded-lg object-cover bg-stone-100 shadow-sm" alt="" />
                                                                        </div>
                                                                    ) : (
                                                                        <div className="w-24 h-28 rounded-lg bg-stone-100 dark:bg-stone-800 flex items-center justify-center flex-shrink-0 shadow-sm">
