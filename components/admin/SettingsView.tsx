                    ...
                    <section className="bg-white dark:bg-stone-900 rounded-xl shadow-[0_2px_20px_-5px_rgba(0,0,0,0.05)] border border-stone-100 dark:border-stone-800 p-5 md:p-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    className="w-full bg-stone-50 dark:bg-stone-950/50 border border-stone-200 dark:border-stone-700 rounded-lg p-4 text-xs font-medium dark:text-white focus:outline-none focus:border-gold-500 focus:ring-1 focus:ring-gold-500 transition-all h-24 resize-none"
                    ...
                    <section className="bg-white dark:bg-stone-900 rounded-xl shadow-[0_2px_20px_-5px_rgba(0,0,0,0.05)] border border-stone-100 dark:border-stone-800 p-5 md:p-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    className="w-full bg-stone-50 dark:bg-stone-950/50 border border-stone-200 dark:border-stone-700 rounded-lg p-4 font-mono text-[10px] dark:text-white focus:outline-none focus:border-gold-500 focus:ring-1 focus:ring-gold-500 h-24 resize-none"
